...
Log into your Hostinger Dashboard and spin up a clean Ubuntu 24.04 LTS instance.
Point your custom automation subdomain (e.g., automation.yourdomain.com) to your Hostinger VPS static IP address via an A Record in your DNS management panel.
